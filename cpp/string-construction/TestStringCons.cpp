...
int main() {
    ...
    std::vector<Testcase> testcases{
       ...
       {"aaaaaaaabbaaabbaaaaaaaa", 2, 9, 38, "   Append * 10 (2 * 10), Clone 'aaabb' (9), Clone 'aaaaaaaa' (9)"},
       {"xxxaaaaabbxxxbbxxxaaaaa", 2, 9, 39, "    Append * 15 (2 * 15), Clone 'xxxaaaaa' (9)"},
        {"abcd;efab;cdief;abcdiefab",10,11,165, ""}
